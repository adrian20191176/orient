...
const Heading = tw(HeadingBase)`text-center lg:text-left text-green-900 leading-snug`;
...
const SectionHeading = tw(HeadingBase)`text-green-900`;
...
const ComponentsType = tw.h3`text-4xl font-black text-green-500 border-b-4 border-green-500 inline-block`;
...
const ComponentPreviewLink = tw.a`mt-4 sm:mt-0 text-green-500 hocus:text-green-900 transition duration-300 font-semibold flex items-center`;
