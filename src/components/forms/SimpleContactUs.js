...
const SubmitButton = tw.button`w-full sm:w-32 mt-6 py-3 bg-gray-100 text-green-500 rounded-full font-bold tracking-wide shadow-lg uppercase text-sm transition duration-300 transform focus:outline-none focus:shadow-outline hover:bg-gray-300 hover:text-green-700 hocus:-translate-y-px hocus:shadow-xl`;
