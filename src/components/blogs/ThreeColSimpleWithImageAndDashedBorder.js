...
const Details = tw.div`p-6 rounded border-2 border-t-0 rounded-t-none border-dashed border-green-100 flex-1 flex flex-col items-center text-center lg:block lg:text-left`;
...
export default ({
  subheading = "Blog",
  heading = <>We Love <span tw="text-green-500">Writing.</span></>,
