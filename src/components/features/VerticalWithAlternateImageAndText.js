...
const Link = tw.a`inline-block mt-4 text-sm text-green-500 font-bold cursor-pointer transition duration-300 border-b-2 border-transparent hover:border-green-500`;
