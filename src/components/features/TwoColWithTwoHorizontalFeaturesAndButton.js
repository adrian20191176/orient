...
const DecoratorBlob = tw(
  SvgDotPattern
)`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-green-500 -z-10`;
...
const FeatureIconContainer = styled.div`
  ${tw`mx-auto inline-block border border-green-500 text-green-500 text-center rounded p-2 flex-shrink-0`}
  ${props => [
